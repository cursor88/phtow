...
router.post('/identify', upload.single('image'), async (req, res) => {
  try {
            ...
            if (retrievalDecisive && !aiMatchesRetrieval) {
              ...
              if (herbData) {
                const result = {
                  ...
                  image: herbData.image || herbData.cover_image_url,
                  cover_image_url: herbData.cover_image_url,
                  food_match: [],
    ...
    const result = {
      ...
      image: analysis.herb.image || analysis.herb.cover_image_url,
      cover_image_url: analysis.herb.cover_image_url,
